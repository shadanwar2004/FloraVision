...
//     <section className="section-padding relative mt-4 pb-6 z-20">
...
//       <div className="glass bg-white/[0.03] rounded-[36px] md:rounded-[60px] p-5 md:p-14 flex flex-col lg:flex-row items-center justify-between gap-6 md:gap-10 mb-10 relative overflow-hidden">
...
//             src={trendingPlant}
//             alt="trending plant"
//             className="w-[170px] md:w-[360px] hover:scale-105 transition-all duration-500"
//           />
...
//           <p className="text-gray-300 mt-4 max-w-[500px] leading-relaxed text-base md:text-lg">
...
function TrendingSection() {
  ...
  return (
    ...
    <section className="section-padding relative mt-0 pb-6 z-20">
      ...
      <div className="glass bg-white/[0.03] rounded-[36px] md:rounded-[60px] p-5 md:p-14 flex flex-col-reverse lg:flex-row items-center justify-between gap-6 md:gap-10 relative overflow-hidden">
        ...
        <div className="flex justify-center flex-1 relative z-10">
          ...
          <img
            src={potPlant}
            alt="pot plant"
            className="w-[170px] md:w-[320px] hover:scale-105 transition-all duration-500"
          />
